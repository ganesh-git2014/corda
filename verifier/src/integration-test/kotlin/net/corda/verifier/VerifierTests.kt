...
class VerifierTests {
    ...
    fun `single verifier works with a node`() {
        verifierDriver(extraCordappPackagesToScan = listOf("net.corda.finance.contracts"),
            ...
            val notaryNode = singleNotaryNode.getOrThrow()
            ...
            aliceNode.rpc.startFlow(::CashIssueFlow, 10.DOLLARS, OpaqueBytes.of(0), defaultNotaryHandle.identity).returnValue.get()
