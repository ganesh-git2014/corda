...
open class PersistentNetworkMapCache(
    ...
    private val justValidatingNotaries = notaries.mapNotNull { if (it.validating) it.identity else null }
    ...
    override fun isValidatingNotary(party: Party): Boolean = party in justValidatingNotaries
